...
7. Use run_terminal_command to append and send all saved section files to \
output/output.md. Wait for user to indicate that the data requirements sheet has \
