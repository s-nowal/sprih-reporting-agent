...
- **For the company**: Determine the industry, profile, frameworks, material topics, KPIs, \
and certifications from available sources. These are crucial for you to extract: Company's \
Annual Report, Company's Official Policy Documents, Information from Company's website, \
newsletters, Social Media posts (such as on LinkedIn) etc.
- **For peer companies**: Formulate a list of 5-6 peer company working in the same industry \
as the company. Search for published ESG Reports, Annual Reports, Official Policy documents, etc.
Search for standards followed in their ESG publications (GRI, SASB, etc.)
